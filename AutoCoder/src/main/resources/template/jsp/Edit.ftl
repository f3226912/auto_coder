	...
	<div>
		<table style="border: none;width: 100%;">
			...
			<tr>
				...
				<td><input type="text" id="${item}" name="${item}" value="${map[item]}" required="true" class="easyui-validatebox" validType="unnormal" missingMessage="${item}必填" style="width: 90%;"></td>
			</tr>
			</#list>
		</table>
	</div>
